        ...
        <div class="flex items-center justify-center">
            <div class="flex flex-col justify-around">
                <div class="space-y-6">
                    ...
                    {{-- TODO: refactor view and buttons and etc etc --}}

                    @auth
                        <span>hello, {{ auth()->user()->username }}</span>
                        <a class="block mx-auto bg-white hover:bg-gray-100 text-center transition-colors duration-200 text-gray-900 font-semibold rounded-lg py-3 px-4"
                           href="/logout"
                        >
                            logout
                        </a>
